...
const LABEL_CONFIG = {
    description: {
        defaultFontSize: 10, // pt (reduzido de 11pt para 10pt)
        minFontSize: 8,      // pt
        maxLines: 2,
        fontWeight: 800,
        fontFamily: 'Arial, sans-serif',
        containerWidth: 280  // px (aproximado baseado no CSS atual)
    }
};
...
function measureTextDimensions(text, fontSize, fontWeight, fontFamily, maxWidth) {
    try {
        // Criar elemento temporário para medição
